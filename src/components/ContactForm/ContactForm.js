        ...
        return (
            <form className={this.classNames.block() + " js--form"}>
                ...
                <div className={this.classNames.element("input-field")}>
                    ...
                    <input type="text" className={this.classNames.element("input-text")} placeholder="First Name" id="first-name" required />
                </div>
                ...
                <div className={this.classNames.element("input-field")}>
                    ...
                    <input type="text" className={this.classNames.element("input-text")} placeholder="Last Name" id="last-name" required />
                </div>
                ...
                <div className={this.classNames.element("btn u-margin-bottom-small")}><Button type='full' width='100%'>Wyślij!</Button></div>
            </form>
        )
    }
}
