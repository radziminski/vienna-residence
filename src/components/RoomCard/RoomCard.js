    ...
    return (
        <div className={classNames.block()}>
            ...
            <div className={classNames.element("details")}>
                <div className={classNames.element("bed")}><IoIosBed className={classNames.element("icon")}/>{props.bed}</div>          
                <div className={classNames.element("people-num")}><IoMdPerson className={classNames.element("icon")}/>{props.people > 1 ? `1 - ${props.people}`: 1}</div> 
            </div>
            ...
            <a href="/" className={classNames.element("btn")}>Reserve now &rarr;</a>
        </div>
    )
}
