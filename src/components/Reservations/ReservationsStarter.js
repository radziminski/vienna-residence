            ...
            <div className={this.classNames.block()}>
                ...
                <div className={this.classNames.element("info-box")}>
                    <div className={this.classNames.element("adults")}>
                        ...
                        <div className={adultMinusIconStyleClass} onClick={this.removeAdultHandler}><FiMinusCircle className={this.classNames.element("icon-small")}/></div>
                        <div className={adultPlusIconStyleClass} onClick={this.addAdultHandler}><FiPlusCircle className={this.classNames.element("icon-small")}/></div>
                        |&emsp;{this.state.childrenNum} {this.state.childrenNum === 1 ? 'child' : 'children'}
                        <div className={childMinusIconStyleClass} onClick={this.removeChildHandler}><FiMinusCircle className={this.classNames.element("icon-small")}/></div>
                        <div className={childPlusIconStyleClass} onClick={this.addChildHandler}><FiPlusCircle className={this.classNames.element("icon-small")}/></div>
                    </div>
                </div>
